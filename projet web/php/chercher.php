...
<body>
<form name="chercher" action="../php/chercher.php" method="GET">
...
<?php 
     ...
     if ($nb===0){
        ...
        echo "<p>nombre de client :  $nb</p>";
     }
     echo "<table>";
     echo"<tr>";
     echo"<th>nom</th>";
     echo"<th>annee apparition </th>";
     echo"<th>email </th>"; 
     ...
     while ($ligne = $reponse->fetchObject()){
        ...
        echo"<td><a href='../php/readpar.php?idClient=".$ligne->idClient."'>details</a></td>";
        echo"<td><a href='../php/updatepar.php?idClient=".$ligne->idClient."'>modifier</a></td>";
        echo"<td><a href='../php/deletepar.php' onclick='confirme(".$ligne->idClient.")'>supprimer</a></td>";
        echo"</tr>";
        echo"</br>";
