...
?>
<form name="update2" method="POST" action="../php/update2.php">
 <div class="form-group  col-md-3"><label for="id">idClient</label><input type="number" name="idClient"  id="id"readonly class="form-control  "
value="<?=$ligne->idClient; ?>"/> </div>
...
else echo"<p> client inexistant</p>";
}
?>
</body>
</html>
